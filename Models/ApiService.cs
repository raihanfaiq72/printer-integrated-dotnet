...
namespace marker_dotnet.Models
{
    ...
    public class ApiService
    {
        ...
        public static async Task<ApiResponse> KirimPermintaanCetakAsync(int jumlahMarker, string device = "desktop")
        {
            try
            {
        ...
        public static async Task UpdateStatusAsync(string invoice, string status, string errorMessage = null)
        {
            try
            {
